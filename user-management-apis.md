...
|-----------------------------------|----------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| User signup                       | /api/user/v1/signup                                 | POST API to create user with  signup attributes (firstName, email/phone, password, emailVerified/phoneVerified). All users created by this end point will be linked with custodian org. This API invokes the updatePassword keycloak API to register the credentials in Keycloak |
