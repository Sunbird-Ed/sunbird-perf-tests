...
apiKey=$8
csvFileHost=$9
csvFileObservation=${10}
csvFileToken=${11}
observationSubmissionListApi=${12}
...
echo "csvFileObservation = " ${csvFileObservation}
echo "csvFileToken = " ${csvFileToken}
echo "observationSubmissionListApi = " ${observationSubmissionListApi}
...
sed "s#OBSERVATION_FILE#${csvFileObservation}#g" $JMX_FILE_PATH > jmx.tmp
mv jmx.tmp $JMX_FILE_PATH

sed "s#TOKEN_FILE#${csvFileToken}#g" $JMX_FILE_PATH > jmx.tmp
mv jmx.tmp $JMX_FILE_PATH


sed "s#PATH_PREFIX#${observationSubmissionListApi}#g" $JMX_FILE_PATH > jmx.tmp
mv jmx.tmp $JMX_FILE_PATH
