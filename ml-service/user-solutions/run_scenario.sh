...
echo "csvSolutionData = " ${csvSolutionData}
echo "userSolutionsApi = " ${userSolutionsApi}
...
sed "s#CSV_SOLUTION#${csvSolutionData}#g" $JMX_FILE_PATH > jmx.tmp
mv jmx.tmp $JMX_FILE_PATH

sed "s#PATH_PREFIX#${userSolutionsApi}#g" $JMX_FILE_PATH > jmx.tmp
mv jmx.tmp $JMX_FILE_PATH
