...
echo "csvFileTemplate = " ${csvFileTemplate}
echo "csvFileToken = " ${csvFileToken}
echo "templateDetailsApi = " ${templateDetailsApi}
...
sed "s#TEMPLATE_FILE#${csvFileTemplate}#g" $JMX_FILE_PATH > jmx.tmp
mv jmx.tmp $JMX_FILE_PATH
...
sed "s#PATH_PREFIX#${templateDetailsApi}#g" $JMX_FILE_PATH > jmx.tmp
mv jmx.tmp $JMX_FILE_PATH
