...
csvFileSolution=${10}
csvFileToken=${11}
getQuestionTemplateDetailsApi=${12}
...
echo "csvFileSolution = " ${csvFileSolution}
echo "csvFileToken = " ${csvFileToken}
echo "getQuestionTemplateDetailsApi = " ${getQuestionTemplateDetailsApi}
...
sed "s#SOLUTION_FILE#${csvFileSolution}#g" $JMX_FILE_PATH > jmx.tmp
mv jmx.tmp $JMX_FILE_PATH
...
sed "s#PATH_PREFIX#${getQuestionTemplateDetailsApi}#g" $JMX_FILE_PATH > jmx.tmp
mv jmx.tmp $JMX_FILE_PATH
