...
echo "csvFileEntity = " ${csvFileEntity}
echo "csvFileToken = " ${csvFileToken}
echo "reportProgramFilterApi = " ${reportProgramFilterApi}
...
sed "s#ENTITY_FILE#${csvFileEntity}#g" $JMX_FILE_PATH > jmx.tmp
mv jmx.tmp $JMX_FILE_PATH
...
sed "s#PATH_PREFIX#${reportProgramFilterApi}#g" $JMX_FILE_PATH > jmx.tmp
mv jmx.tmp $JMX_FILE_PATH
