...
echo "csvFileLink = " ${csvFileLink}
echo "csvFileToken = " ${csvFileToken}
echo "verifyLinkApi = " ${verifyLinkApi}
...
sed "s#LINK_FILE#${csvFileLink}#g" $JMX_FILE_PATH > jmx.tmp
mv jmx.tmp $JMX_FILE_PATH
...
sed "s#PATH_PREFIX#${verifyLinkApi}#g" $JMX_FILE_PATH > jmx.tmp
mv jmx.tmp $JMX_FILE_PATH
