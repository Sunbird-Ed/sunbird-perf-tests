...
echo "csvFileLocation = " ${csvFileLocation}
echo "csvFileToken = " ${csvFileToken}
echo "subEntityListApi = " ${subEntityListApi}
...
sed "s#LOCATION_FILE#${csvFileLocation}#g" $JMX_FILE_PATH > jmx.tmp
mv jmx.tmp $JMX_FILE_PATH
...
sed "s#PATH_PREFIX#${subEntityListApi}#g" $JMX_FILE_PATH > jmx.tmp
mv jmx.tmp $JMX_FILE_PATH
