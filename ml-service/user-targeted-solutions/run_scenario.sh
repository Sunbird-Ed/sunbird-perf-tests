...
SCENARIO_LOGS=/Users/niit/Documents/logs/$scenario_name
...
cp /Users/niit/Documents/$scenario_name/$scenario_name.jmx $JMX_FILE_PATH
...
echo "csvSearchData = " ${csvSearchData}
echo "csvLocationData = " ${csvLocationData}
echo "csvTypeData = " ${csvTypeData}
echo "userTargetedSolutionsApi = " ${userTargetedSolutionsApi}
...
sed "s#CSV_FILE#${csvSearchData}#g" $JMX_FILE_PATH > jmx.tmp
mv jmx.tmp $JMX_FILE_PATH

sed "s#CSV_LOCATION_FILE#${csvLocationData}#g" $JMX_FILE_PATH > jmx.tmp
mv jmx.tmp $JMX_FILE_PATH

sed "s#CSV_TYPE_FILE#${csvTypeData}#g" $JMX_FILE_PATH > jmx.tmp
mv jmx.tmp $JMX_FILE_PATH

sed "s#PATH_PREFIX#${userTargetedSolutionsApi}#g" $JMX_FILE_PATH > jmx.tmp
mv jmx.tmp $JMX_FILE_PATH
