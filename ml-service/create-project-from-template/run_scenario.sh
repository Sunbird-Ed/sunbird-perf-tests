...
csvFileSolution=${10}
csvFileToken=${11}
createProjectFromTemplateApi=${12}
...
echo "createProjectFromTemplateApi = " ${createProjectFromTemplateApi}
...
sed "s#PATH_PREFIX#${createProjectFromTemplateApi}#g" $JMX_FILE_PATH > jmx.tmp
mv jmx.tmp $JMX_FILE_PATH
