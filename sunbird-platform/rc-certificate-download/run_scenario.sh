...
echo "csvCertificate = " ${csvCertificate}
echo "certificateDownloadApi = " ${certificateDownloadApi}
...
sed "s#CSV_CERT#${csvCertificate}#g" $JMX_FILE_PATH > jmx.tmp
mv jmx.tmp $JMX_FILE_PATH


sed "s#PATH_PREFIX#${certificateDownloadApi}#g" $JMX_FILE_PATH > jmx.tmp
mv jmx.tmp $JMX_FILE_PATH
