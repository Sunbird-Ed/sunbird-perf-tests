...
echo "csvFileDialcode = " ${csvFileDialcode}
echo "dialcodeUpdateApi = " ${dialcodeUpdateApi}
...
sed "s#CSV_DIALCODE#${csvFileDialcode}#g" $JMX_FILE_PATH > jmx.tmp
mv jmx.tmp $JMX_FILE_PATH

sed "s#PATH_PREFIX#${dialcodeUpdateApi}#g" $JMX_FILE_PATH > jmx.tmp
mv jmx.tmp $JMX_FILE_PATH
