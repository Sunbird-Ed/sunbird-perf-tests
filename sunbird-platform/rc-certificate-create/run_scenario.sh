...
echo "csvFileCourses = " ${csvFileCourses}
echo "csvFileUser = " ${csvFileUser}
echo "certificateCreateApi = " ${certificateCreateApi}
...
sed "s#CSV_COURSE#${csvFileCourses}#g" $JMX_FILE_PATH > jmx.tmp
mv jmx.tmp $JMX_FILE_PATH

sed "s#CSV_USER#${csvFileUser}#g" $JMX_FILE_PATH > jmx.tmp
mv jmx.tmp $JMX_FILE_PATH

sed "s#PATH_PREFIX#${certificateCreateApi}#g" $JMX_FILE_PATH > jmx.tmp
mv jmx.tmp $JMX_FILE_PATH
